...
if (empty($_REQUEST['name'])) {
	...
	echo '<br>';
	echo '<br>';
	echo '<input class="btn1" type="button" onclick="history.back()" value="登録画面に戻る">';
} else
if (!empty($result)) {
	echo 'すでに登録されています';
	echo '<br>';
	...
	echo '<br>';
	echo '<br>';
	echo '<input class="btn1" type="button" onclick="location.href=\'./course_list.php\'" value="リストに戻る">';
} 
?>
